...
| 阶段四 | 工具生态与外围组件集成（工具调用 / 向量库 / RAG / MCP，含综合实战 Demo） | [04-阶段四-工具生态与外围组件集成](04-阶段四-工具生态与外围组件集成) |
...
| 迁移心智陷阱清单 | 从旧领域/旧思维迁移到 Agent 开发时的认知陷阱与破解抓手 | [13-迁移心智陷阱清单.md](13-迁移心智陷阱清单.md) |
